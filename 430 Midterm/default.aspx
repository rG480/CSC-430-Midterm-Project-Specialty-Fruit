                ...
                <div class="modal-content">
                   ...
                   <h4> Please enter the  fruit ID, quantity ordered, and customer ordering.</h4>
                    ...
                    <div> 
                     ...
                     <div>
                            <asp:TextBox ID="CustomerName" runat="server" placeholder="Customer Name"></asp:TextBox>
                            <asp:RegularExpressionValidator runat="server" ControlToValidate="CustomerName"
                                ErrorMessage="[Aa-Zz], ['] and [.] only!" ValidationExpression="[a-zA-Z ' , .]{1,50}" />
                        </div>
        ...
        <div id="modifyInvModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-group">
                        <asp:TextBox ID="modInvQuant" runat="server" Type="number" Text="Set Quantity Here"></asp:TextBox>
                        <asp:RegularExpressionValidator runat="server" ControlToValidate="modInvQuant"
                            ErrorMessage="Numbers greater than 1 only!" ValidationExpression="^[0-9]\d*$" />
                    </div>
